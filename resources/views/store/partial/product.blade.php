            ...
            <div class="single-products">
                <div class="productinfo text-center">
                    ...
                    <a href="{{route('cart.add',['id'=>$product->id])}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Adicionar no carrinho</a>
                        ...
                        @else
                            <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-crosshairs"></i>Produto vendido</a>

                            <a href="{{route('store.index')}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Outras opções</a>
